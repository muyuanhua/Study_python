...
class GetData:
    ...
    def get_request_header(self,row):
        col=int(data_config.get_request_header())
    ...
    def get_header_value(self,row):
        oper_json=OperationJson(r"D:\PyApi_heartdub\Fabric_api\dataconfig\request_header.json")
    ...
    def get_data_value(self,row):
        oper_json=OperationJson(r"D:\PyApi_heartdub\Fabric_api\dataconfig\request_data.json")
